...
?>
    ...
    <strong>Bulan : <?= bulanindonesia($bulan); ?>, Tahun : <?= $tahun; ?></strong>
        ...
        <table class="table table-bordered table-striped table-responsive">
            ...
            ?>
            <tr>
                <td colspan="14"><a class="btn btn-success btn-sm" href="cetak_laporan_gaji_pegawai.php?bulan=<?= $bulan;?>&tahun=<?= $tahun;?>" target="_blank">Cetak Laporan Gaji Pegawai</a></td>
            </tr>
        </table>
        <!-- </div> -->
        </div>
