...
<html lang="en">
  <head>
    ...
    <title>Login Aplikasi Penggajian Pegawai CV. Sari Bumi Sakti</title>
    ...
    <style>
      ...
      body{
        background: url(assets/img/logoo.jpg) no-repeat center fixed;
   ...
   <div class="container">
    <div class="col-md-4 col-md-offset-4">
      ...
      <div class="panel-body" >
        <center>
        <img src="assets/img/capdaun.jpg" class="img" alt="Logo" width="200">
        <hr>
